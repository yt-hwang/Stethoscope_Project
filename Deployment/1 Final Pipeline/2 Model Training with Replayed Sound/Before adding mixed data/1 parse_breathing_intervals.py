...
OUT_JSON = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Deployment/1 Final Pipeline/2 Model Training with Replayed Sound/Output/breathing_nonbreathing_intervals.json")      # 출력 JSON 파일
# Windows
