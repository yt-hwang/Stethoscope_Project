# -*- coding: utf-8 -*-
# extract_Logmel.py
# (변경 요약) 입력 루트를 커버리지 윈도우(AUG_ROOT)만 사용하도록 축소
#  - Segments_2s_hop500ms는 혼합을 피하기 위해 제외(최소 변경)
...
SEG_ROOT = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Deployment/1 Final Pipeline/5 Realtime Pipeline_Final/Output/Segments_2s_hop500ms")
AUG_ROOT = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Deployment/1 Final Pipeline/5 Realtime Pipeline_Final/Output/Augmented_Windows_by_Coverage")
...
# 변경: 커버리지 윈도우만 사용
INPUT_ROOTS = [p for p in [AUG_ROOT] if p.exists()]
