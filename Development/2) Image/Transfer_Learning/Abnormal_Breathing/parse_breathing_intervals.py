...
#OUT_JSON = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Development/2) Image/Transfer_Learning/Abnormal_Breathing/breathing_nonbreathing_intervals.json")      # 출력 JSON 파일
# Windows
EXCEL_PATH = Path("D:\\Stethoscope_Project\\Audio shared\\ML test sound list\\ML test sound list breathing info.xlsx")   # 입력 Excel 파일
OUT_JSON = Path("D:\\Stethoscope_Project\\Development\\2) Image\\Transfer_Learning\\Abnormal_Breathing\\breathing_nonbreathing_intervals.json")      # 출력 JSON 파일

DURATION_SEC = 30.0                                           # 전체 오디오 길이(초)
STRICT_DROP = False                                            # 더러운 데이터가 있으면 파일 자체를 제거
# ======================
