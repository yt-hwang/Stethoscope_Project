#!/usr/bin/env python3
# train_tl_img_breathing_efficientnet_75_25_scalogram.py
# 논문식: 샘플(타일) 기준 75/25 stratified split + EfficientNet-B0 전이학습
# 입력 manifest는 스케일로그램 타일용 manifest.csv
...
# ===== 경로/설정 =====
MANIFEST = Path(
    "/Users/yunhwang/Desktop/Stethoscope_Project/Development/9.2) Reference/BreathingTiles_scalo_paper/manifest.csv"
)
