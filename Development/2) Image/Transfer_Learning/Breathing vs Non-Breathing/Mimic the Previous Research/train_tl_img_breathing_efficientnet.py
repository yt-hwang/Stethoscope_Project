...
# 논문식 전처리 타일(2s/hop0.5) 기반 이진 분류 (EfficientNet-B0, GroupKFold)
...
# ===== 경로/설정 =====
MANIFEST = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Development/9.2) Reference/BreathingTiles_mel_paper/manifest.csv")
OUTDIR   = MANIFEST.parent / "models_efficientnet_b0_binary_paper"
