#!/usr/bin/env python3
"""
Cycle D2: Seg + Full Pipeline - Excel Logging
"""
...
def create_cycle_summary_row():
    """Create cycle summary row for D2"""
    return {
        'Cycle_ID': 'D2',
        'Phase': 'D_Seg_SmartCombinations',
        'Segmentation': '10_seconds',
        'Preprocessing': 'full_pipeline_peak_normalize_bandpass_spectral_gating_highpass',
        'Representations': 'raw_waveform_stats, logmel_mean, mfcc_mean',
        'Clustering_Algos': 'KMeans(k=3,4,5), HDBSCAN',
        'Output_Root': '/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/D2_Seg_FullPipeline/outputs',
        'Notes': 'Complete preprocessing pipeline: Seg + PeakNormalize + Bandpass(100-2000Hz) + SpectralGating + HighPass(20Hz)'
    }
...
def main():
    parser = argparse.ArgumentParser(description='Log Cycle D2 results to Excel')
    parser.add_argument('--output_dir', 
                       default='/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/D2_Seg_FullPipeline/outputs',
    ...
    print(f"Logged Cycle D2 results to {args.excel_path}")
