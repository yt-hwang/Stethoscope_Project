#!/usr/bin/env python3
"""
Cycle B2: NoSeg + PeakNormalize + Bandpass + SpectralGating - Clustering and Evaluation
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run clustering for Cycle B2')
    ...
    print(f"\nClustering completed for Cycle B2: NoSeg + PeakNormalize + Bandpass + SpectralGating")
