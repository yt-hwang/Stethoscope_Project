#!/usr/bin/env python3
"""
Log B0_new cycle results to Excel tracking system
"""
...
OUTPUT_ROOT = '/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/B0_new_NoSeg_PeakNormalize_HighPass/outputs'
CYCLE_ID = 'B0_new'
PHASE = 'B-Series_New'
SEGMENTATION = 'NoSeg'
...
NOTES = 'Better combination: PeakNormalize + HighPass (best A-Series combination)'
...
def main():
    parser = argparse.ArgumentParser(description="Log B0_new cycle results to Excel.")
