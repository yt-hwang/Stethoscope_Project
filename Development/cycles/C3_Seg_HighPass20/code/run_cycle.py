#!/usr/bin/env python3
"""
Cycle C3: Seg + HighPass(20 Hz) - Main Runner
"""
...
def main():
    ...
    print("="*60)
    print("CYCLE C3: Seg + HighPass(20 Hz)")
    print("="*60)
    ...
    print("\n" + "="*60)
    print("CYCLE C3 COMPLETED SUCCESSFULLY!")
    print("="*60)
    print(f"Output directory: {output_dir}")
    print("Next: Run robust evaluation to compare with A3 and C0")
