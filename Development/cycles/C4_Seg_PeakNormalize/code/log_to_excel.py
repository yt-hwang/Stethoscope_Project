#!/usr/bin/env python3
"""
Cycle C4: Seg + PeakNormalize - Excel Logging
"""
...
def create_cycle_summary_row():
    """Create cycle summary row for C4"""
    return {
        'Cycle_ID': 'C4',
        ...
        'Output_Root': '/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/C4_Seg_PeakNormalize/outputs',
        'Notes': 'Segmentation with peak normalization - tests how segmentation affects A4 method'
    }
...
def main():
    parser = argparse.ArgumentParser(description='Log Cycle C4 results to Excel')
    ...
    print(f"Logged Cycle C4 results to {args.excel_path}")
