#!/usr/bin/env python3
"""
Cycle A3: NoSeg + HighPass(20 Hz) - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle A3')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle A3: {rep} - {algo_name.upper()}\nHighPass(20 Hz) Preprocessing"
    ...
    print(f"\nVisualization completed for Cycle A3: NoSeg + HighPass(20 Hz)")
