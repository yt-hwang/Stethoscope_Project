...
def create_umap_visualization(features, labels, representation_name, algorithm_name, output_dir):
    ...
    output_file = os.path.join(output_dir, 'visualizations', f'umap_{representation_name}_{algorithm_name}.png')
...
def main():
    ...
    for rep_name, csv_file in representations.items():
        ...
        metrics_path = os.path.join(args.output_dir, 'clustering', f'clustering_{rep_name}_metrics.json')
