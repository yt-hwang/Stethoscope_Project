#!/usr/bin/env python3
"""
Cycle D0: Seg + HighPass + PeakNormalize - Main Runner
"""
...
def main():
    ...
    print("="*60)
    print("CYCLE D0: Seg + HighPass + PeakNormalize")
    print("="*60)
    print(f"Audio directory: {audio_dir}")
    print(f"Output directory: {output_dir}")
    print("Preprocessing: High-pass filter (20 Hz) + Peak normalization")
    
    # Step 1: Extract features
    print("\n1. Extracting features...")
    if not run_script(script_dir / "extract_features.py", 
                     ["--audio_dir", audio_dir, "--output_dir", str(output_dir)]):
        print("CYCLE D0 FAILED!")
        return
    ...
    print("\n" + "="*60)
    print("CYCLE D0 COMPLETED SUCCESSFULLY!")
    print("="*60)
    print(f"Output directory: {output_dir}")
    print("Next: Run robust evaluation to compare with C3 and C4")
