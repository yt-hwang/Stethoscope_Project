#!/usr/bin/env python3
"""
Cycle B1: NoSeg + PeakNormalize + Bandpass - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle B1')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle B1: {rep} - {algo_name.upper()}\nPeakNormalize + Bandpass Preprocessing"
    ...
    print(f"\nVisualization completed for Cycle B1: NoSeg + PeakNormalize + Bandpass")
