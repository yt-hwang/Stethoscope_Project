#!/usr/bin/env python3
"""
Cycle B1: NoSeg + PeakNormalize + Bandpass - Feature Extraction
Combines A4 (PeakNormalize) + A1 (Bandpass) - consistency + performance
"""
...
def process_audio_file(file_path, sr=16000):
    ...
    try:
        ...
        # Apply combined preprocessing: PeakNormalize + Bandpass
        ...
        audio_processed = apply_bandpass_filter(audio_normalized, sr, low_freq=100, high_freq=2000)
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for Cycle B1')
    ...
    print(f"\nFeature extraction completed for Cycle B1: NoSeg + PeakNormalize + Bandpass")
