#!/usr/bin/env python3
"""
Cycle C1: Seg + Bandpass - Main Runner
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("CYCLE C1 COMPLETED SUCCESSFULLY!")
    print("="*60)
    print(f"Output directory: {output_dir}")
    print("Next: Run robust evaluation to compare with A1 and C0")
