#!/usr/bin/env python3
"""
Cycle C2: Seg + SpectralGating - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle C2')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle C2: {rep} - {algo_name.upper()}\nSegmented (10s) + Spectral Gating"
    ...
    print(f"\nVisualization completed for Cycle C2: Seg + SpectralGating")
