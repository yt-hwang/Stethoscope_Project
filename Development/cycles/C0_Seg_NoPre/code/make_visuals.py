#!/usr/bin/env python3
"""
Cycle C0: Seg + NoPreprocess - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle C0')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle C0: {rep} - {algo_name.upper()}\nSegmented (10s) + NoPreprocess"
    ...
    print(f"\nVisualization completed for Cycle C0: Seg + NoPreprocess")
