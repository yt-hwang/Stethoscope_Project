#!/usr/bin/env python3
"""
Cycle A4: NoSeg + PeakNormalize - Clustering and Evaluation
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run clustering for Cycle A4')
    ...
    print(f"\nClustering completed for Cycle A4: NoSeg + PeakNormalize")
