#!/usr/bin/env python3
"""
Cycle B0: NoSeg + Bandpass + SpectralGating - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle B0')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle B0: {rep} - {algo_name.upper()}\nBandpass + SpectralGating Preprocessing"
    ...
    print(f"\nVisualization completed for Cycle B0: NoSeg + Bandpass + SpectralGating")
