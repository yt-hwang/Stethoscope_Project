#!/usr/bin/env python3
"""
A1: NoSeg + Bandpass - Clustering Analysis
...
def main():
    parser = argparse.ArgumentParser(description='Run clustering for A1: NoSeg + Bandpass - New Data Experiment')
    ...
    print("🧪 NEW DATA EXPERIMENT - A1: Clustering Analysis")
    print("=" * 60)
