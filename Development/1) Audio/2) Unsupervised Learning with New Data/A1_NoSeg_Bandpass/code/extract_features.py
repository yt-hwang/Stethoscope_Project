#!/usr/bin/env python3
"""
A1: NoSeg + Bandpass - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
Apply bandpass filtering (100-2000 Hz) before feature extraction
"""
...
def process_audio_file(file_path, target_sr=16000):
    ...
    try:
        ...
        # PREPROCESSING: Apply bandpass filter (100-2000 Hz)
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for A1: NoSeg + Bandpass - New Data Experiment')
    ...
    print("🧪 NEW DATA EXPERIMENT - A1: NoSeg + Bandpass")
    print("=" * 60)
