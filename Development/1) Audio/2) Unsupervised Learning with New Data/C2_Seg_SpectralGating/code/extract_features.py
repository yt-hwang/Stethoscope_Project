#!/usr/bin/env python3
"""
C2: Seg + SpectralGating - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
Apply segmentation (10s windows) + spectral gating before feature extraction
Testing segmentation effect on original winner method!
"""
...
def process_audio_file(file_path, target_sr=16000):
    ...
    try:
        ...
        for i, segment in enumerate(segments):
            # PREPROCESSING: Apply spectral gating
            segment_processed = spectral_gating(segment, sr)
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for C2: Seg + SpectralGating - New Data Experiment')
    ...
    parser.add_argument('--output_dir', type=str,
                       default='/Users/yunhwang/Desktop/Stethoscope_Project/Development/Unsupervised Learning with New Data/C2_Seg_SpectralGating/outputs',
    ...
    print("NEW DATA EXPERIMENT - C2: Seg + SpectralGating")
    print("=" * 60)
    ...
    print("Testing segmentation effect on original winner method!")
    print()
