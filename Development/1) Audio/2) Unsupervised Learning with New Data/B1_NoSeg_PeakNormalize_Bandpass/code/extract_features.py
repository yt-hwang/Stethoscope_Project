#!/usr/bin/env python3
"""
B1: NoSeg + PeakNormalize + Bandpass - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
Apply peak normalization + bandpass filtering before feature extraction
"""
...
def process_audio_file(file_path, target_sr=16000):
    ...
    try:
        ...
        # PREPROCESSING: Apply peak normalization + bandpass filter
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for B1: NoSeg + PeakNormalize + Bandpass - New Data Experiment')
    ...
    parser.add_argument('--output_dir', type=str,
                       default='/Users/yunhwang/Desktop/Stethoscope_Project/Development/Unsupervised Learning with New Data/B1_NoSeg_PeakNormalize_Bandpass/outputs',
    ...
    print('NEW DATA EXPERIMENT - B1: NoSeg + PeakNormalize + Bandpass')
    print('=' * 60)
    print(f'Dataset: RAW sound_ML test sound list')
    print(f'Found {len(audio_files)} audio files')
    print(f'Preprocessing: Peak normalization + Bandpass (100-2000 Hz)')
    print()
