#!/usr/bin/env python3
"""
A2: NoSeg + SpectralGating - UMAP Visualizations
...
def create_umap_plot(features, labels, filenames, representation, algorithm, params_str, output_path):
    ...
    plt.title(f'UMAP: {representation} with {algorithm} ({params_str})\nA2: NoSeg + SpectralGating - NEW DATA EXPERIMENT\n🏆 ORIGINAL WINNER (0.658)', 
...
def main():
    parser = argparse.ArgumentParser(description="Generate UMAP visualizations for A2 clustering results - New Data Experiment")
    ...
    print("🧪 NEW DATA EXPERIMENT - A2: Creating Visualizations")
    print("🏆 TESTING ORIGINAL WINNER (0.658)")
    print("=" * 60)
