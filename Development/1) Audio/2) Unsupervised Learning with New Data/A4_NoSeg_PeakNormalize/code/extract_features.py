#!/usr/bin/env python3
"""
A4: NoSeg + PeakNormalize - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
Apply peak normalization before feature extraction
"""
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for A4: NoSeg + PeakNormalize - New Data Experiment')
    ...
    parser.add_argument('--output_dir', type=str,
                       default='/Users/yunhwang/Desktop/Stethoscope_Project/Development/Unsupervised Learning with New Data/A4_NoSeg_PeakNormalize/outputs',
    ...
    print("NEW DATA EXPERIMENT - A4: NoSeg + PeakNormalize")
    print("=" * 60)
