#!/usr/bin/env python3
"""
A0: NoSeg + NoPreprocess - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
No preprocessing applied, extract features directly from raw audio
"""
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for A0: NoSeg + NoPreprocess - New Data Experiment')
    ...
    print("🧪 NEW DATA EXPERIMENT - A0: NoSeg + NoPreprocess")
    print("=" * 60)
    print(f"Dataset: RAW sound_ML test sound list")
    print(f"Found {len(audio_files)} audio files")
    print(f"Preprocessing: None (baseline)")
    print()
