#!/usr/bin/env python3
"""
A3: NoSeg + HighPass20 - Feature Extraction
NEW DATA EXPERIMENT - Using RAW sound_ML test sound list
Apply high-pass filtering (20 Hz) before feature extraction
"""
...
def process_audio_file(file_path, target_sr=16000):
    ...
    try:
        ...
        audio_processed = highpass_filter(audio, sr, cutoff_freq=20)
...
def main():
    parser = argparse.ArgumentParser(description='Extract features for A3: NoSeg + HighPass20 - New Data Experiment')
    ...
    parser.add_argument('--output_dir', type=str,
                       default='/Users/yunhwang/Desktop/Stethoscope_Project/Development/Unsupervised Learning with New Data/A3_NoSeg_HighPass20/outputs',
    ...
    print("🧪 NEW DATA EXPERIMENT - A3: NoSeg + HighPass20")
    print("=" * 60)
