#!/usr/bin/env python3
"""
Create Handcrafted Features Visualizations
==========================================
Creates timeline visualizations for handcrafted features breathing classification
Everything stays the same except titles (OPERA-CT → Handcrafted Features)
"""
...
class HandcraftedModelTrainer:
    ...
    def run_experiment(self, segment_length):
        ...
        best_predictions = individual_results[best_model_name]['predictions']
        ...
        # Create final_predictions with only TEST segments (same as OPERA-CT)
        final_predictions = {}
        ...
        # Create visualizations for each file (same as OPERA-CT)
        for filename, predictions in final_predictions.items():
            ...
            fig = self.create_timeline_visualization(
                ...
                predictions, segment_length, best_model_name, file_accuracy
            )
...
def main():
    ...
    trainer = HandcraftedModelTrainer()
