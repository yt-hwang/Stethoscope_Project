...
SEGMENTS_DIR = 'D:\\Stethoscope_Project\\Development\\1) Audio\\0) Data\\segments_2000ms'  # From step 2
FEATURES_DIR = 'D:\\Stethoscope_Project\\Development\\1) Audio\\6) OPERA + Feature Extraction + XXX\\opera_features'
...
def load_opera_ct_model():
    ...
    try:
        ...
        import sys
        sys.path.append(r"D:\Stethoscope_Project\OPERA") 
