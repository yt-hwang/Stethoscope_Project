#!/usr/bin/env python3
"""
Cycle A4: NoSeg + PeakNormalize - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle A4')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle A4: {rep} - {algo_name.upper()}\nPeak Normalization Preprocessing"
    ...
    print(f"\nVisualization completed for Cycle A4: NoSeg + PeakNormalize")
