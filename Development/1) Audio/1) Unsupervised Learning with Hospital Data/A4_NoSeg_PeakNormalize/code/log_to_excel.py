#!/usr/bin/env python3
"""
Cycle A4: NoSeg + PeakNormalize - Excel Logging
"""
...
def create_cycle_summary_row():
    """Create cycle summary row for A4"""
    return {
        'Cycle_ID': 'A4',
        'Phase': 'A_NoSeg',
        'Segmentation': 'none',
        ...
        'Output_Root': '/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/A4_NoSeg_PeakNormalize/outputs',
        'Notes': 'Peak normalization to scale audio to [-1, 1] range'
    }
...
def main():
    parser = argparse.ArgumentParser(description='Log Cycle A4 results to Excel')
    ...
    print(f"Logged Cycle A4 results to {args.excel_path}")
