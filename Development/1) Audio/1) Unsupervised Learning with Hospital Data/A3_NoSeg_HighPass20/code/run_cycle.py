#!/usr/bin/env python3
"""
Cycle A3: NoSeg + HighPass(20 Hz) - Main Runner
"""
...
def main():
    ...
    print("="*60)
    print("CYCLE A3: NoSeg + HighPass(20 Hz)")
    print("="*60)
    
    # Step 1: Extract features
    print("\n1. Extracting features...")
    if not run_script(script_dir / "extract_features.py"):
        print("CYCLE A3 FAILED!")
        return
    ...
    print("\n" + "="*60)
    print("CYCLE A3 COMPLETED SUCCESSFULLY!")
    print("="*60)
    print(f"Output directory: {output_dir}")
    print("Next: Run robust evaluation to compare with A0, A1, A2")
