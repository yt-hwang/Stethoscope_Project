#!/usr/bin/env python3
"""
Cycle D1: Seg + HighPass + Bandpass - Feature Extraction
"""
...
def main():
    parser = argparse.ArgumentParser(description="Extract features from segmented audio with high-pass filtering + bandpass filtering.")
    ...
    for i, file_path in enumerate(audio_files):
        ...
        try:
            ...
            y_processed = highpass_filter(y, sr, cutoff=20)
