#!/usr/bin/env python3
"""
Cycle C1: Seg + Bandpass - Clustering and Evaluation
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run clustering for Cycle C1')
    ...
    print(f"\nClustering completed for Cycle C1: Seg + Bandpass")
