#!/usr/bin/env python3
"""
Cycle C1: Seg + Bandpass - Visualization
"""
...
def main():
    parser = argparse.ArgumentParser(description='Create visualizations for Cycle C1')
    ...
    for rep in representations:
        ...
        for algo_name, metrics in clustering_results.items():
            ...
            # Create UMAP plot
            title = f"Cycle C1: {rep} - {algo_name.upper()}\nSegmented (10s) + Bandpass (100-2000 Hz)"
    ...
    print(f"\nVisualization completed for Cycle C1: Seg + Bandpass")
