#!/usr/bin/env python3
"""
Cycle D0: Seg + HighPass + PeakNormalize - Feature Extraction
"""
...
def main():
    parser = argparse.ArgumentParser(description="Extract features from segmented audio with high-pass filtering + peak normalization.")
    ...
    for i, file_path in enumerate(audio_files):
        ...
        try:
            ...
            y_processed = peak_normalize(y_processed)
