#!/usr/bin/env python3
"""
Orchestrate the execution of D0_new: Seg + PeakNormalize + HighPass
"""
...
def main():
    ...
    print("Combines: C4 (PeakNormalize) + C3 (HighPass) - Top 2 C-Series performers")
    ...
    try:
        ...
        print("\n" + "="*80)
        print("D0_new COMPLETED SUCCESSFULLY!")
        print("="*80)
        print(f"Output directory: {OUTPUT_DIR}")
