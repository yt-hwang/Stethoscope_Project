#!/usr/bin/env python3
"""
Extract features from segmented audio files with PeakNormalize + HighPass preprocessing.
This combines the top 2 C-Series performers: C4 (PeakNormalize) + C3 (HighPass)
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract features from segmented audio files with PeakNormalize + HighPass preprocessing."
    )
