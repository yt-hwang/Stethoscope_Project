#!/usr/bin/env python3
"""
Cycle B1: NoSeg + PeakNormalize + Bandpass - Clustering and Evaluation
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run clustering for Cycle B1')
    ...
    print(f"\nClustering completed for Cycle B1: NoSeg + PeakNormalize + Bandpass")
