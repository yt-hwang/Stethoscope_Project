#!/usr/bin/env python3
"""
Cycle B0: NoSeg + Bandpass + SpectralGating - Excel Logging
"""
...
def create_cycle_summary_row():
    """Create cycle summary row for B0"""
    return {
        'Cycle_ID': 'B0',
        ...
        'Output_Root': '/Users/yunhwang/Desktop/Stethoscope_Project/Development/cycles/B0_NoSeg_Bandpass_SpectralGating/outputs',
        'Notes': 'Combination of A1 (Bandpass) + A2 (SpectralGating) - top 2 A-Series performers'
    }
...
def main():
    parser = argparse.ArgumentParser(description='Log Cycle B0 results to Excel')
    ...
    print(f"Logged Cycle B0 results to {args.excel_path}")
