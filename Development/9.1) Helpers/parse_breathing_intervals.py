...
OUT_JSON = Path("/Users/yunhwang/Desktop/Stethoscope_Project/Audio shared/breathing_nonbreathing_intervals.json")      # 출력 JSON 파일
DURATION_SEC = 30.0                                           # 전체 오디오 길이(초)
STRICT_DROP = True                                            # 더러운 데이터가 있으면 파일 자체를 제거
# ======================
